                ...
                <div class="entry-content">
                    <div class="woocommerce table-tabs" id="responsiveTabs">
                        <ul class="nav nav-tabs">
                            <li class="active"><b class="arrow-up"></b><a data-toggle="tab" href="#sectionA">Seus Livros
                                ({{ Auth::user()->contHas() }})</a></li>
                                <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionB">Para ler
                                    ({{ Auth::user()->contToRead() }})</a></li>
                                    <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionC">Lidos
                                        ({{ Auth::user()->contRead() }})</a></li>
                                        <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionD">Favoritos
                                            ({{ Auth::user()->contFav() }})</a></li>
                                        </ul>
                                                            ...
                                                            <td data-title="Product" class="product-name">
                                                                <span class="product-thumbnail">
                                                                    ...
                                                                    <span class="product-detail">
                                                                        ...
                                                                        <td data-title="action" class="product-action">
                                                                            <div class="dropdown">
                                                                                ...
                                                                                class="dropdown-toggle">Opções</a>
                                                                                <ul class="dropdown-menu">
                                                                                    <li><a
                                                                                        href="{{ route('paraLer', ['book' => $book->id]) }}">Para
                                                                                    Ler</a></li>
                                                                                    <li><a
                                                                                        href="{{ route('jaLido', ['book' => $book->id]) }}">Já
                                                                                    Lido</a></li>
                                                                                    <li><a
                                                                                        href="{{ route('paraFav', ['book' => $book->id]) }}">Fazer
                                                                                    anotações</a></li>
                                                                        ...
                                                                        <td class="product-remove">
                                                                            Este livro foi adicionado dia x/x/x aos Seus livros. <br> <a
                                                                            href="{{ route('remove', ['book' => $book->id]) }}">Remover</a>
                                                                        </td>
                                                                    </tr>
                                                                    @else
                                                                    <p>você não possui nenhum livro ainda, vá em adicionar livros e escolha um!</p>
                                                                    @endif

                                                                    @endforeach

                                                                    {{-- @if(!Auth::user()->hasBook($books))
                                                                    ...
                                                                    @endif --}}
                                                                       ...
                                                                       <td class="product-remove">
                                                                       Este livro foi adicionado ao Para Ler. <br> <a
                                                                       href="{{ route('removeToRead', ['book' => $book->id]) }}">Remover</a>
                                                                       </td>
                                                                       </tr>
                                                                       ...
                                                                       <td class="product-remove">
                                                                       Este livro foi adicionado ao seus livros Lidos. <br> <a
                                                                       href="{{ route('removeRead', ['book' => $book->id]) }}">Remover</a>
                                                                       </td>
                                                                       </tr>
                                                                       ...
                                                                       <td class="product-remove">
                                                                       Este livro foi adicionado aos seus Favoritos. <br> <a
                                                                       href="{{ route('removeFav', ['book' => $book->id]) }}">Remover</a>
                                                                       </td>
                                                                       </tr>
